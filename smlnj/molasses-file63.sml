(* parse-sml/src/lex-mlb/MLBToken.sml : 1.1-207.1 *)
(* molasses-file63.sml *)
...
structure MLBToken :>
  sig
    ...
    datatype reserved = Bas | Basis | Ann | UnderscorePrim
    (** This is MLton-specific *)

    datatype class =
    SMLPath | MLBPath | Reserved of reserved | SML of Token.class
