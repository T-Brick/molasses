(* parse-sml/src/parse/ParseFunNameArgs.sml : 1.1-126.1 *)
(* molasses-file59.sml *)
    ...
    fun fname_args toks infdict i =
      let
        ...
        fun isInfixedValueIdentifierNoEqual i =
          check Token.isValueIdentifierNoEqual i andalso InfixDict.isInfix
                                                           infdict
                                                           (tok i)
      ...
      in
        if isInfixedValueIdentifierNoEqual i then
          ...
          case firstPat of
            Ast.Pat.Parens { left = lp
                           , right = rp
                           , pat = Ast.Pat.Infix {left, id, right}
                           } =>
