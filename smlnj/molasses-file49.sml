(* parse-sml/src/ast/AstType.sml : 1.1-926.1 *)
(* molasses-file49.sml *)
  ...
  struct
    ...
    structure Pat =
      struct
        ...
        (** can only appear at end of record pattern *)
    ...
    structure Exp =
      struct
        ...
        type typbind =
          { elems : { tyvars : Token.t SyntaxSeq.t
                    , tycon : Token.t
                    , eq : Token.t
                    , ty : Ty.t
                    } Seq.t
        ...
        datatype fname_args =
          PrefixedFun of
                        {opp : Token.t option, id : Token.t, args : Pat.t Seq.t}
        ...
        type 'exp fvalbind =
          { elems : { elems : { fname_args : fname_args
                              , ty : {colon : Token.t, ty : Ty.t} option
                              , eq : Token.t
                              , exp : 'exp
                              } Seq.t
        ...
        | MLtonSpecific of
                          { underscore : Token.t
                          (** must be exactly adjacent to the directive *)
                          , directive : Token.t
                          (** prim, import, etc. *)
    ...
    (** =======================================================================
      ...
      *)
    datatype topdec =
    SigDec of Sig.sigdec | StrDec of Str.strdec | FunDec of Fun.fundec
