...
structure GenFile :
  sig
    ...
    val apply : (CMFile.t -> 'a) * (WrappedFile.t -> 'a) * (rename -> 'a) * (toplevel -> 'a)
                  -> generated
                  -> 'a
    val map : (CMFile.t -> CMFile.t) * (WrappedFile.t -> WrappedFile.t) * (rename -> rename) * (toplevel -> toplevel)
                -> generated
                -> generated
  ...
  struct
    ...
    fun createMark (src, g) =
      map
        ( fn cm => CMFile.createMark (src, cm)
