(* parse-sml/src/base/lib/Color.sml : 1.1-86.1 *)
(* molasses-file26.sml *)
...
structure Color =
  struct
    ...
    fun approxHumanPerceptionDistance ( {red = r1, green = g1, blue = b1}
    ...
    local
      ...
      fun sq x = x * x
    in
      fun sqDistance ( {red = r1, green = g1, blue = b1}
                     , {red = r2, green = g2, blue = b2}
                     ) =
        sq (c r2 - c r1)
        + sq (c g2 - c g1)
    ...
    fun hsv {h : real, s : real, v : real} : pixel =
      let
        ...
        fun to256 channel = Word8.fromInt (Real.ceil (channel * 255.0))
      in
