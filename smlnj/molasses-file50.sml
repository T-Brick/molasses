(* parse-sml/src/ast/Ast.sml : 1.1-197.1 *)
(* molasses-file50.sml *)
  ...
  struct
    ...
    structure Pat =
      struct
        ...
        fun okayForAsPat pat =
          isValueIdentifier pat orelse case pat of
                                         Typed {pat, ...} =>
        ...
        fun isAppPat pat =
          isAtPat pat orelse (case pat of
                                Con _ => true
                              | _ => false)

        fun isInfPat pat =
          isAppPat pat orelse (case pat of
                                 Infix _ => true
                               | _ => false)
    ...
    structure Exp =
      struct
        ...
        fun isAppExp exp =
          isAtExp exp orelse (case exp of
                                App _ => true
                              | _ => false)

        fun isInfExp exp =
          isAppExp exp orelse (case exp of
                                 Infix _ => true
                               | _ => false)
        ...
        fun checkValidFValBind (fvalbind : exp fvalbind) (error : { what : string
                                                                  , pos : Source.t
